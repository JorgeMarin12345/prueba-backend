...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Accesorios - Editar') }}</div>
                ...
                <div class="card-body">
                    <form action="{{ route('productos.update',$producto->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control{{ $errors->has('sku') ? ' is-invalid' : '' }}" name="sku" value="{{ $producto->sku }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <textarea style="width:100%;" name="descripcion" rows="4">{{ $producto->descripcion }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('pais_origen') ? ' is-invalid' : '' }}" name="pais_origen" value="{{ $producto->pais_origen }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('fabricante') ? ' is-invalid' : '' }}" name="fabricante" value="{{ $producto->fabricante }}" required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <select name="categoria_id">
                                    @foreach ($categorias as $categoria)
                                      <option {{ $producto->categoria_id==$categoria->id ? ' selected' : '' }} value="{{$categoria->id}}">{{$categoria->nombre}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
